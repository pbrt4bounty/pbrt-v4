...
OpenPBRMaterial *OpenPBRMaterial::Create(const TextureParameterDictionary &parameters,
    ...
    FloatTexture specular_uroughness =
        parameters.GetFloatTexture("specular_uroughness", 1.0f, alloc);
    ...
    FloatTexture coat_uroughness =
        parameters.GetFloatTexture("coat_uroughness", 1.0f, alloc);
    FloatTexture coat_vroughness =
        parameters.GetFloatTexture("coat_vroughness", 0.0f, alloc);
...
CookTorranceMaterial *CookTorranceMaterial::Create(
    ...
    return alloc.new_object<CookTorranceMaterial>(reflectance, uRoughness, vRoughness,
                                                  albedo, eta, displacement, normalMap,
                                                  remapRoughness);
}
